...
file_list_number=1
for i in files:
    file_list=file_list+('{number}<a style="margin-left:100px" href="menu4.py?id={file_list}">{file_list}</a><br>'.format(file_list=i, number=file_list_number))
    file_list_number+=1
...
<html lang="ko" dir="ltr">
  ...
  <body>
    ...
    <div id="webworld">
    <p><h1 style="margin-top:50px;margin-bottom:50px;"> 견적문의</h1></p>
    <div id="webworld2">
